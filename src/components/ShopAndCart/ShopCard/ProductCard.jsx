    ...
    <>
      <div className="bg-white md:w-96 mx-auto shadow-md rounded-2xl p-6 hover:-translate-y-1.5 duration-700 hover:shadow-[#4f39f6]/50 ">
        ...
        <button
          ...
          className="btn w-full text-white text-[16px] font-bold rounded-full transition-all duration-500 bg-linear-to-r from-[#4f39f6] to-[#9514fa] shadow-sm hover:shadow-[#9514fa] border-none hover:  hover:bg-linear-to-r hover:from-[#9514fa] hover:to-[#4f39f6] md:mb-1"
        >
          Buy Now
        </button>
      </div>
