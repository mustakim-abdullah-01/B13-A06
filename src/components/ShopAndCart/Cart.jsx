...
const Cart = ({ cart, setCart }) => {
  ...
  // const onClickProceedHandler = (product) =>{
      ...
      <div className="p-10 container mx-auto">
        ...
        <div className="flex flex-col gap-4 mb-6">
          ...
          <div className="flex justify-between">
            ...
            <p className="text-[#101727] text-2xl font-bold">0</p>
          </div>

          <button className="h-13 btn font-semibold transition-colors duration-500 text-white bg-linear-to-r from-[#4f39f6] to-[#9514fa]  rounded-full text-[16px]  hover:bg-linear-to-r hover:from-[#9514fa] hover:to-[#4f39f6]">
            Proceed to Checkout
          </button>
        </div>
      </div>
