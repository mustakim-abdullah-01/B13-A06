...
const Hero = () => {
  return (
    <>
      <div className="hero-div container mx-auto md:py-16 flex max-md:gap-8 max-md:flex-col-reverse justify-between items-center">
        ...
        <div className="left-div px-1.5 flex justify-center max-md:items-center flex-col gap-9">
          ...
          <div className="content-div flex flex-col gap-4">
            ...
            <div className="slogan-div">
              <h1
                className="font-extrabold text-5xl md:text-7xl text-[#101727]"
              >
                Supercharge Your <br />
                Digital Workflow
              </h1>
          ...
          <div className="button-div flex flex-wrap max-md:justify-center gap-2 md:gap-4">
            ...
            <button
              className="btn btn-outline h-13 btn-primary px-4 py-3 flex justify-center items-center gap-1 hover:bg-[#4f39f6] duration-700 rounded-full hover:text-[#ffff] font-Extrabold text-[16px] "
            >
              <Play />
              Watch Demo
            </button>
